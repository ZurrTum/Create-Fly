...
public enum AllGuiTextures implements ScreenElement, TextureSheetSegment {
    ...
    // Inventories
    PLAYER_INVENTORY("player_inventory", 176, 108), WAND_OF_SYMMETRY("curiosities", 0, 131, 188, 101), BLOCKZAPPER(
        "curiosities",
        0,
        99,
        214,
    ...
    SCHEMATIC("schematics", 10, 8, 192, 123), SCHEMATIC_TITLE("schematics_2", 205, 15), SCHEMATIC_SLOT(
        "widgets",
        54,
        0,
        16,
        16
    ), SCHEMATIC_PROMPT("schematics_2", 213, 79), HUD_BACKGROUND("overlay", 0, 0, 16, 16),

    SCHEMATIC_TABLE("schematics", 10, 139, 214, 85), SCHEMATIC_TABLE_PROGRESS("schematics", 10, 224, 84, 16),

    SCHEMATICANNON_TOP("schematics_2", 0, 77, 213, 42), SCHEMATICANNON_BOTTOM(
        "schematics_2",
        0,
        119,
        213,
    ...
    POSTBOX_HEADER("frogport_and_mailbox", 0, 23, 214, 24), FROGPORT_HEADER(
    ...
    TOOLBOX("toolbox", 188, 171), TOOLBELT_SLOT("widgets", 0, 68, 22, 22), TOOLBELT_SLOT_HIGHLIGHT(
        ...
        24,
        24
    ), TOOLBELT_MAIN_SLOT("widgets", 0, 97, 24, 24), TOOLBELT_EMPTY_SLOT(
        "widgets",
        27,
        98,
        22,
    ...
    TOOLBELT_HOTBAR_OFF("widgets", 0, 130, 20, 24), TOOLBELT_HOTBAR_ON(
        "widgets",
        20,
        130,
        20,
    ...
    CLIPBOARD("clipboard", 0, 0, 256, 256), CLIPBOARD_ADDRESS("widgets", 116, 7, 8, 8), CLIPBOARD_ADDRESS_INACTIVE(
        "widgets",
        125,
        7,
        8,
    ...
    DATA_GATHERER("display_link", 235, 162), DATA_AREA_START("display_link", 0, 163, 2, 18), DATA_AREA_SPEECH(
        "display_link",
        8,
        163,
        5,
    ...
    SCHEDULE("schedule", 256, 226), SCHEDULE_CARD_DARK("schedule", 5, 233, 1, 1), SCHEDULE_CARD_MEDIUM(
        ...
        1,
        1
    ), SCHEDULE_CARD_LIGHT("schedule", 7, 233, 1, 1), SCHEDULE_CARD_MOVE_UP(
        "schedule",
        51,
        230,
        12,
        12
    ), SCHEDULE_CARD_MOVE_DOWN("schedule", 65, 230, 12, 12), SCHEDULE_CARD_REMOVE(
        "schedule",
        51,
        243,
        12,
        12
    ), SCHEDULE_CARD_DUPLICATE("schedule", 65, 243, 12, 12), SCHEDULE_CARD_NEW(
        "schedule",
        79,
        239,
        16,
        16
    ), SCHEDULE_CONDITION_NEW("schedule", 96, 239, 19, 16), SCHEDULE_CONDITION_LEFT(
        "schedule",
        116,
        239,
        6,
    ...
    STATION("schedule_2", 0, 111, 200, 127), STATION_ASSEMBLING("assemble", 200, 178), STATION_TEXTBOX_TOP(
        ...
        150,
        18
    ), STATION_TEXTBOX_MIDDLE("assemble", 1, 198, 150, 1), STATION_TEXTBOX_BOTTOM(
        "assemble",
        1,
        200,
        150,
        4
    ), STATION_TEXTBOX_SPEECH("assemble", 152, 179, 8, 6), STATION_EDIT_NAME(
        "schedule_2",
        0,
        239,
        13,
        13
    ), STATION_EDIT_TRAIN_NAME("schedule_2", 89, 239, 13, 13), I_NEW_TRAIN(
        "schedule_2",
        14,
        239,
        24,
    ...
    BRASS_FRAME_TL("value_settings", 65, 9, 4, 4), BRASS_FRAME_TR("value_settings", 70, 9, 4, 4), BRASS_FRAME_BL(
        "value_settings",
        65,
        19,
        4,
        4
    ), BRASS_FRAME_BR("value_settings", 70, 19, 4, 4), BRASS_FRAME_LEFT(
        "value_settings",
        65,
        14,
        3,
        4
    ), BRASS_FRAME_RIGHT("value_settings", 71, 14, 3, 4), BRASS_FRAME_TOP(
        "value_settings",
        0,
        24,
        256,
    ...
    VALUE_SETTINGS_MILESTONE("value_settings", 0, 0, 7, 8), VALUE_SETTINGS_WIDE_MILESTONE(
        "value_settings",
        75,
        14,
        13,
        8
    ), VALUE_SETTINGS_BAR("value_settings", 7, 0, 249, 8), VALUE_SETTINGS_BAR_BG(
        "value_settings",
        75,
        9,
        1,
    ...
    STOCK_KEEPER_SEARCH_SYNC_BOTH("stock_keeper", 160, 176, 15, 16), STOCK_KEEPER_SEARCH_SYNC_FROM_STOCK_KEEPER(
        "stock_keeper",
        176,
        176,
        15,
    ...
    BUTTON("widgets", 18, 18), BUTTON_HOVER("widgets", 18, 0, 18, 18), BUTTON_DOWN(
        ...
        18,
        6
    ), INDICATOR_YELLOW("widgets", 54, 18, 18, 6), INDICATOR_RED("widgets", 72, 18, 18, 6),
    ...
    TRAIN_HUD_SPEED_BG("widgets", 0, 190, 182, 5), TRAIN_HUD_SPEED("widgets", 0, 185, 182, 5), TRAIN_HUD_THROTTLE(
        "widgets",
        0,
        195,
        182,
        5
    ), TRAIN_HUD_THROTTLE_POINTER("widgets", 0, 209, 6, 9), TRAIN_HUD_FRAME(
        "widgets",
        0,
        200,
        186,
    ...
    // Train Map
    TRAINMAP_SPRITES("trainmap_sprite_sheet", 0, 0, 512, 256), TRAINMAP_SIGNAL(
        "widgets",
        81,
        156,
        5,
        10
    ), TRAINMAP_STATION_ORTHO("widgets", 49, 156, 5, 5), TRAINMAP_STATION_DIAGO(
        "widgets",
        56,
        156,
        5,
