...
public class AllRenderPipelines {
    public static final ResourceLocation GLOWING_ID = ResourceLocation.fromNamespaceAndPath(MOD_ID, "core/glowing_shader");
    ...
    public static final RenderPipeline ADDITIVE = RenderPipeline.builder(RenderPipelines.TERRAIN_SNIPPET)
        .withLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "pipeline/additive")).withBlend(BlendFunction.ADDITIVE).withCull(false).build();
    public static final RenderPipeline ADDITIVE2 = RenderPipeline.builder(RenderPipelines.TERRAIN_SNIPPET)
        .withLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "pipeline/additive2")).withBlend(BlendFunction.ADDITIVE).withCull(false)
        .withDepthWrite(false).build();
    public static final RenderPipeline GLOWING = RenderPipeline.builder(GLOWING_SNIPPET)
        .withLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "pipeline/glowing"))
    ...
    public static final RenderPipeline GLOWING_TRANSLUCENT = RenderPipeline.builder(GLOWING_SNIPPET)
        .withLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "pipeline/glowing_translucent")).withBlend(BlendFunction.TRANSLUCENT).build();
    public static final RenderPipeline CUBE = RenderPipeline.builder(RenderPipelines.PARTICLE_SNIPPET)
        .withLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "pipeline/cube"))
        .withBlend(new BlendFunction(SourceFactor.SRC_ALPHA, DestFactor.ONE_MINUS_SRC_ALPHA, SourceFactor.SRC_ALPHA, DestFactor.ONE_MINUS_SRC_ALPHA))
        .withDepthWrite(false).build();
}
