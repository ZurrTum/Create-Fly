...
public record FluidConfig(
    Supplier<TextureAtlasSprite> still, Supplier<TextureAtlasSprite> flowing, Function<DataComponentPatch, Integer> tint, Supplier<Float> fogDistance, int fogColor
) {
