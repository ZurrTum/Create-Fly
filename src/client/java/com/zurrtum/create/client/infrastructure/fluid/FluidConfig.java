...
public record FluidConfig(
    Supplier<Sprite> still, Supplier<Sprite> flowing, Supplier<Integer> tint, Supplier<Float> fogDistance, int fogColor
) {
    ...
    public FluidConfig(Supplier<Sprite> still, Supplier<Sprite> flowing, Supplier<Integer> tint) {
