...
public class AllCreatePonderTags {
    ...
    public static void register(PonderTagRegistrationHelper<Identifier> helper) {
        ...
        PonderTagRegistrationHelper<Item> HELPER = helper.withKeyFunction(Registries.ITEM::getId);

        PonderTagRegistrationHelper<ItemConvertible> itemHelper = helper.withKeyFunction(RegisteredObjectsHelper::getKeyOrThrow);
