...
public class PumpScenes {
    ...
    public static void flow(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlock(pumpPos, s -> s.with(PumpBlock.FACING, s.get(PumpBlock.FACING).getOpposite()), false);
        ...
        Box bb1 = new Box(Vec3d.ZERO, Vec3d.ZERO).expand(.25, .25, 0).offset(0, 0, .25);
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, out, bb1.offset(util.vector().centerOf(1, 1, 1).add(0, 0, -.5)), 3);
        scene.idle(2);
        ...
        scene.overlay().showControls(util.vector().topOf(pumpPos), Pointing.DOWN, 40).rightClick().withItem(AllItems.WRENCH.getDefaultStack());
        scene.idle(7);
    ...
    public static void speed(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().setBlock(east, AllBlocks.GLASS_FLUID_PIPE.getDefaultState().with(GlassFluidPipeBlock.AXIS, Axis.X), false);

        scene.world().setBlock(pumpPos.south(), AllBlocks.COGWHEEL.getDefaultState().with(CogWheelBlock.AXIS, Axis.X), false);
        ...
        BlockState pipeState = AllBlocks.FLUID_PIPE.getDefaultState().with(FluidPipeBlock.DOWN, false).with(FluidPipeBlock.UP, false);
        ...
        scene.world().setBlock(east.north(), pipeState.with(FluidPipeBlock.NORTH, false).with(FluidPipeBlock.EAST, false), false);
        scene.world().setBlock(east.south(), pipeState.with(FluidPipeBlock.SOUTH, false).with(FluidPipeBlock.EAST, false), false);
        ...
        scene.world().setBlock(west.north(), pipeState.with(FluidPipeBlock.NORTH, false).with(FluidPipeBlock.WEST, false), false);
        scene.world().setBlock(west.south(), pipeState.with(FluidPipeBlock.SOUTH, false).with(FluidPipeBlock.WEST, false), false);
