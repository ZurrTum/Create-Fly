...
public record ItemTransformRenderState(TrackingItemStackRenderState state, Matrix3x2f pose, ScreenRectangle bounds,
                                       int x0, int y0, int x1, int y1, int padding, float scale, float xRot, float yRot,
                                       float zRot,
