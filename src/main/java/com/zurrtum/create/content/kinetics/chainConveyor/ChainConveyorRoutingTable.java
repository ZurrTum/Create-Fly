...
public class ChainConveyorRoutingTable {
    ...
    public record RoutingTableEntry(
        String port, int distance, BlockPos nextConnection, MutableInt timeout, boolean endOfRoute
    ) {
        ...
        public RoutingTableEntry copyForNeighbour(BlockPos connection) {
            return new RoutingTableEntry(port, distance + 1, connection.multiply(-1), new MutableInt(ENTRY_TIMEOUT), false);
        }
