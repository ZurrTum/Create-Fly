...
public record EjectorAwardPacket(BlockPos pos) implements Packet<ServerPlayPacketListener> {
    ...
    public void apply(ServerPlayPacketListener listener) {
        AllHandle.onEjectorAward((ServerPlayNetworkHandler) listener, this);
    }
