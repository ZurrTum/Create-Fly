...
public record ContraptionInteractionPacket(InteractionHand hand, int target, BlockPos localPos, Direction face) implements C2SPacket {
    ...
    @Override
    public BiConsumer<ServerGamePacketListenerImpl, ContraptionInteractionPacket> callback() {
