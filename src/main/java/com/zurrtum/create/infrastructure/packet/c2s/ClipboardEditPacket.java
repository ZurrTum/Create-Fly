...
public record ClipboardEditPacket(int hotbarSlot, ComponentChanges dataComponentPatch, @Nullable BlockPos targetedBlock) implements C2SPacket {
    public static final PacketCodec<RegistryByteBuf, ClipboardEditPacket> CODEC = PacketCodec.tuple(
        ...
        ClipboardEditPacket::dataComponentPatch,
